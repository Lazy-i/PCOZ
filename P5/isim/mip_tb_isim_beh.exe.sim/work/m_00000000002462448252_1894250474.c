...
#endif
static const char *ng0 = "H:/ISE/P5/Forward.v";
static int ng1[] = {0, 0};
static int ng2[] = {3, 0};
static int ng3[] = {2, 0};
static int ng4[] = {1, 0};
...
LAB70:    t620 = (t0 + 6384);
    ...
    *((unsigned int *)t630) = (t632 | t626);
    xsi_driver_vfirst_trans(t620, 0, 1);
    t633 = (t0 + 6240);
    *((int *)t633) = 1;
...
LAB112:    memcpy(t412, t374, 8);

LAB113:    memset(t232, 0, 8);
    t444 = (t412 + 4);
...
LAB66:    xsi_vlog_unsigned_bit_combine(t3, 32, t226, 32, t231, 32);
    goto LAB70;
...
LAB129:    t455 = ((char*)((ng3)));
    goto LAB130;

LAB131:    t462 = (t0 + 1048U);
    t463 = *((char **)t462);
    t462 = (t0 + 2168U);
    t464 = *((char **)t462);
    memset(t465, 0, 8);
...
LAB147:    memcpy(t501, t480, 8);

LAB148:    memset(t533, 0, 8);
    t534 = (t501 + 4);
...
LAB161:    memcpy(t571, t533, 8);

LAB162:    memset(t461, 0, 8);
    t603 = (t571 + 4);
...
LAB177:    t610 = (t461 + 4);
    t611 = *((unsigned int *)t461);
    t612 = *((unsigned int *)t610);
    t613 = (t611 || t612);
    if (t613 > 0)
        goto LAB178;

LAB179:    t615 = *((unsigned int *)t461);
    t616 = (~(t615));
...
LAB181:    if (*((unsigned int *)t610) > 0)
        goto LAB182;

LAB183:    if (*((unsigned int *)t461) > 0)
        goto LAB184;

LAB185:    memcpy(t460, t619, 8);

LAB186:    goto LAB132;

LAB133:    xsi_vlog_unsigned_bit_combine(t231, 32, t455, 32, t460, 32);
    goto LAB137;
...
LAB150:    if (*((unsigned int *)t492) != 0)
        goto LAB151;

LAB152:    t502 = *((unsigned int *)t480);
...
LAB153:    t513 = *((unsigned int *)t501);
    t514 = *((unsigned int *)t507);
    *((unsigned int *)t501) = (t513 | t514);
    t515 = (t480 + 4);
    t516 = (t494 + 4);
    t517 = *((unsigned int *)t480);
    t518 = (~(t517));
    t519 = *((unsigned int *)t515);
    t520 = (~(t519));
    t521 = *((unsigned int *)t494);
    t522 = (~(t521));
...
LAB168:    if (*((unsigned int *)t564) != 0)
        goto LAB169;

LAB170:    t572 = *((unsigned int *)t533);
...
LAB178:    t614 = ((char*)((ng4)));
    goto LAB179;

LAB180:    t619 = ((char*)((ng1)));
    goto LAB181;

LAB182:    xsi_vlog_unsigned_bit_combine(t460, 32, t614, 32, t619, 32);
    goto LAB186;

LAB184:    memcpy(t460, t614, 8);
    goto LAB186;
...
LAB101:    if (*((unsigned int *)t335) != 0)
        goto LAB102;

LAB103:    t343 = *((unsigned int *)t304);
...
LAB111:    t385 = ((char*)((ng4)));
    goto LAB112;

LAB113:    t390 = ((char*)((ng1)));
    goto LAB114;

LAB115:    xsi_vlog_unsigned_bit_combine(t231, 32, t385, 32, t390, 32);
    goto LAB119;
...
extern void work_m_00000000002462448252_1894250474_init()
{
	static char *pe[] = {(void *)Cont_53_0,(void *)Cont_57_1,(void *)Cont_61_2,(void *)Cont_64_3,(void *)Cont_67_4};
	xsi_register_didat("work_m_00000000002462448252_1894250474", "isim/mip_tb_isim_beh.exe.sim/work/m_00000000002462448252_1894250474.didat");
