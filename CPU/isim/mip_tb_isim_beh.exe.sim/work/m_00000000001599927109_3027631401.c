...
#endif
static const char *ng0 = "H:/ISE/CPU/PCA.v";
static int ng1[] = {4, 0};
...
LAB22:    t69 = (t0 + 2488U);
    ...
    t69 = ((char*)((ng1)));
    memset(t73, 0, 8);
    xsi_vlog_unsigned_add(t73, 32, t72, 32, t69, 32);
    goto LAB23;
...
LAB53:    if (*((unsigned int *)t99) > 0)
        goto LAB54;

LAB55:    memcpy(t98, t117, 8);

LAB56:    goto LAB38;

LAB39:    xsi_vlog_unsigned_bit_combine(t78, 32, t93, 32, t98, 32);
    goto LAB43;

LAB41:    memcpy(t78, t93, 8);
    goto LAB43;
...
LAB52:    xsi_vlog_unsigned_bit_combine(t98, 32, t112, 32, t117, 32);
    goto LAB56;

LAB54:    memcpy(t98, t112, 8);
    goto LAB56;

}


extern void work_m_00000000001599927109_3027631401_init()
{
	static char *pe[] = {(void *)Cont_34_0,(void *)Cont_35_1,(void *)Cont_36_2,(void *)Cont_37_3};
	xsi_register_didat("work_m_00000000001599927109_3027631401", "isim/mip_tb_isim_beh.exe.sim/work/m_00000000001599927109_3027631401.didat");
